...
Algorithm 2, uses a similar method, but instead of drawing a rectangular box around the pdf, it transforms the box into a different shape---a triangle---making it more efficient. This is made possible because


$$0 \leq w \leq1 ~~w\in[\frac{y^*}{2},1]$$
